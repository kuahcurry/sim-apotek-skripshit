...
const breadcrumbItems: BreadcrumbItem[] = [
    ...
    { title: 'Barang Masuk', href: '/transaksi/masuk' },
];

export default function BarangMasuk({ transaksi, stats, filters }: Props) {
                ...
                <div className="flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
                    <div>
                        ...
                        <p className="text-sm text-muted-foreground">
                            Riwayat transaksi obat masuk ke apotek
                        </p>
                    </div>
                    <Button asChild>
                    ...
                    <div className="rounded-lg border bg-card p-6">
                        <div className="flex items-center justify-between">
                            <div>
                                ...
                                <p className="text-xs text-muted-foreground mt-1">Item Masuk</p>
                            </div>
                            <BoxIcon className="size-8 text-blue-500" />
                        </div>
                    </div>
                                ...
                                {transaksi.data.length === 0 ? (
                                    <TableRow>
                                        <TableCell colSpan={10} className="text-center py-8">
                                            ...
                                            <p className="text-muted-foreground">Belum ada transaksi masuk</p>
                                        </TableCell>
                                    </TableRow>
                                ) : (
                        ...
                        <div className="flex items-center justify-between px-4 py-4 border-t">
                            ...
                            <div className="flex gap-2">
                                <Button
                                    variant="outline"
                                    size="sm"
                                    onClick={() => router.get(`/transaksi/masuk?page=${transaksi.current_page - 1}`)}
